...
def test_get_list(client: TestClient, app: FastAPI) -> None:
    ...
    with app.container.user_repository.override(repository_mock):  # type: ignore[attr-defined] # noqa
...
def test_get_by_id(client: TestClient, app: FastAPI) -> None:
    repository_mock = mock.Mock(spec_set=UserRepository)
...
def test_get_by_id_404(client: TestClient, app: FastAPI) -> None:
    repository_mock = mock.Mock(spec=UserRepository)
...
def test_add(_: object, client: TestClient, app: FastAPI) -> None:
    repository_mock = mock.Mock(spec=UserRepository)
...
def test_remove(client: TestClient, app: FastAPI) -> None:
    repository_mock = mock.Mock(spec=UserRepository)
...
def test_remove_404(client: TestClient, app: FastAPI) -> None:
    repository_mock = mock.Mock(spec=UserRepository)
